...
*   **Frontend Dashboard (GitHub Pages)**: [https://anirudhbhatt.github.io/Monetra/](https://anirudhbhatt.github.io/Monetra/)
...
The static frontend is hosted on GitHub Pages. Any push to the `main` branch of [AnirudhBhatt/Monetra](https://github.com/AnirudhBhatt/Monetra) automatically compiles and deploys the update.
